...
function About() {
  return (
    ...
    >
      ...
      >
        <Typography component={"div"} className="headerContainer">
          <Typography
            component={"h1"}
            sx={{
              justifyContent: "center",
          ...
          >
            ...
            da tecnologia. Somos uma equipe apaixonada e inovadora,
            especializada no desenvolvimento de Aplicações Desktop, Web e
            Mobile, Marketing Digital e Produção Multimídia. Nossa missão é
            criar soluções digitais que não apenas atendam, mas superem as
            expectativas dos nossos clientes. Criamos aplicações robustas e
            ...
            para impulsionar sua marca e alcançar seu público-alvo. Estamos
            ...
            digital da sua empresa. Juntos, vamos transformar ideias em
            inovação!
          </Typography>
