...
const rows = [
  createData(1, 2492, '10 de julho de 2023', '34582ddfd535', '1828372hdgdss', 'check-sample.jpg',),
  createData(2, 1292, '05 de junho de 2023', '345853sfsgdg5', '1828372hdgdss', 'check-sample.jpg',),
  createData(3, 1492, '10 de Agosto de 2023', '34wqwff58535', '1828372hdgdss', 'check-sample.jpg',),
  createData(4, 12892, '08 de Agosto de 2023', '34sd585sad35', '1828372hdgdss', 'check-sample.jpg',),
];
                                      ...
                                      <TableCell align={'center'} sx={{fontFamily: 'Arvo, serif', fontSize: '12px', fontWeight: 600}}>
                                        ...
                                        <TableCell align={'center'}>
                                            <Button 
                                                ...
                                                variant="contained"
                                            >
                                                <Task sx={{ color: `${primery}`, fontSize: '20px'}} />
                                            </Button>                
                                      </TableCell>
