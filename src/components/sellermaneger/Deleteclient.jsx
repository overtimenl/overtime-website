...
function Deleteclient({ client, setClient, setOpenModel, primery, secudary }) {
    ...
    const handleDelete = (e) => { 
        ...
        axios.delete(`http://localhost:8000/anunciodb/${client.id}`)
        .then(response => {
            setCor('#00809b')
        ...
        >
            ...
            >
                <Box sx={{mb: 2}}>
                    ...
                    >
                        {`Tem certeza que dezeja exluir o cliente: ${client.name} ?`}
                    </Typography>
                    <Typography
                        sx={{
                            justifyContent: 'center',
