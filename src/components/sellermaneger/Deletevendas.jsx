...
function Deletevendas({ anuncio, setAnuncios, setOpenModel, primery, secudary }) {
        ...
        >
            ...
            >
                <Box sx={{mb: 2}}>
                    ...
                    >
                        {`Tem certeza que dezeja exluir a venda da aplicação: ${anuncio.app} ?`}
                    </Typography>
                    <Typography
                        sx={{
                            justifyContent: 'center',
