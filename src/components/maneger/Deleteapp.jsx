...
function Deleteapp({ aplicacao, setAplicacao, setOpenModel, primery, secudary }) {
    ...
    const handleDelete = (e) => { 
        ...
        axios.delete(`http://localhost:8000/anunciodb/${aplicacao.id}`)
        .then(response => {
            setCor('#00809b')
        ...
        >
            ...
            >
                <Box sx={{mb: 2}}>
                    ...
                    >
                        {`Tem certeza que dezeja exluir o usuario: ${aplicacao.name} ?`}
                    </Typography>
                    <Typography
                        sx={{
                            justifyContent: 'center',
