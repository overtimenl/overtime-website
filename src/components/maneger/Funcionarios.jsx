...
function createData(id, name, bi, cell, email, endereco, profissao, data_create, image) {
  return {id, name, bi, cell, email, endereco, profissao, data_create, image};
}


const rows = [
    createData(1, 'Pedro Mzongi', '83282424MN944', '923 564 584','pedromzongi@gmail.com', 'Luanda, viana, caop-b, rua: pedro Nzimba nº25','GESTOR DE MIDIAS', '10 de julho de 2023', 'juvenalll.jpg'),
    createData(2, 'Nzimba Pedro', '83282424MN944', '923 564 584','pedromzongi@gmail.com', 'Luanda, viana, caop-b, rua: pedro Nzimba nº25','CONTABILISTA', '10 de julho de 2023', 'juvenalll.jpg'),
    createData(3, 'Florinda Miranda', '83282424MN944', '923 564 584','pedromzongi@gmail.com', 'Luanda, viana, caop-b, rua: pedro Nzimba nº25','VENDEDOR', '10 de julho de 2023', 'juvenalll.jpg'),
    createData(4, 'Jacito Milto', '83282424MN944', '923 564 584','pedromzongi@gmail.com', 'Luanda, viana, caop-b, rua: pedro Nzimba nº25','RECURSOS HUMANOS', '10 de julho de 2023', 'juvenalll.jpg'),
    createData(5, 'Mzinga Phanzo', '83282424MN944', '923 564 584','pedromzongi@gmail.com', 'Luanda, viana, caop-b, rua: pedro Nzimba nº25','ORGANIZACAO', '10 de julho de 2023', 'juvenalll.jpg'),
...
function Funcionarios(props) {
    ...
    const getComponent = () =>{
      switch(opcao){
        ...
        case 'EDITAR':           
              return <Formfuncionario foto={funcionaro.image} opcao={opcao} funcionaro={funcionaro} setFuncionaro={setFuncionaro}  setOpenModel={setOpenModel} primery={primery} secudary={secudary}   />; 
        case 'APAGAR':
              return <Deletefuncionario funcionario={funcionaro} setFuncionario={setFuncionaro} setOpenModel={setOpenModel} primery={primery} secudary={secudary}/>;   
        case 'PAYMENT':
                      ...
                      <TableContainer sx={{ maxHeight: 440 }}>
                          ...
                          <TableHead>
                              <TableRow className={classes.root}>
                                  ...
                                  <TableCell                       
                                      align={'center'}
                                      style={{ minWidth: 100, fontFamily: 'Arvo, serif', fontWeight: 600, fontSize: '12px' }}
                                  >
                                      FOTO
                                  </TableCell>
                              ...
                              .map((row) => {
                                  ...
                                  <TableRow hover role="checkbox" tabIndex={-1} key={row.id}>        
                                      ...
                                      <TableCell align={'center'}>
                                            <img                  
                                                src={new URL(`../../assets/funcionarios/${row.image}`, import.meta.url)}
                                                width={40}
                                                height={40}
                                            />                                 
                                      </TableCell>
                                      
                                      <TableCell align={'center'} sx={{fontFamily: 'Arvo, serif', fontSize: '10px'}}>
                                          {row.name}
                                      </TableCell>
