...
import { IconButton, Grid,Typography, Box, Button,  Paper, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow } from '@mui/material';
import { MonetizationOn, HowToReg, RequestPage, ForwardToInbox, Visibility, VisibilityOff, AccountBalance, Delete, Edit} from '@mui/icons-material';
...
function Vendas(props) {
    ...
    const getComponent = () =>{
        switch (opcao) {
            case 'SELLER':
                return <Sellerbox seller={seller} setASeller={setSeller} setOpenModel={setOpenModel} primery={primery} secudary={secudary} />;
            case 'EDITAR':           
                return  <Vendabox total={(venda.valor).toLocaleString("en-US", {style:"currency", currency:"USD"})} data={venda.data} app={venda.app} client={venda.client} setOpenModel={setOpenModel} comprovante={venda.image}  primery={primery} secudary={secudary} />;
            case 'DELETE':
                return <Deletevendas anuncio={venda} setOpenModel={setOpenModel}  primery={primery} secudary={secudary} />
            case 'BANK':
                                      ...
                                      <TableCell align={'center'} sx={{fontFamily: 'Arvo, serif', fontSize: '12px', fontWeight: 600}}>
                                        ...
                                        <TableCell align={'center'}>
                                        	<IconButton 
	                                                ...
	                                                color="inherit"
	                                            >
	                                                <HowToReg sx={{ color: 'blue', fontSize: '20px'}} />
	                                        </IconButton>
                                        	{row.paymented ?
                                        		<IconButton 
                                        		...
                                        		<IconButton 
	                                                ...
	                                                color="inherit"
	                                            >
	                                                <MonetizationOn sx={{ color: `${primery}`, fontSize: '20px'}} />
	                                            </IconButton>
                                            ...
                                            <IconButton 
                                                ...
                                                color="inherit"
                                            >
                                                <RequestPage sx={{ color: `${primery}`, fontSize: '20px'}} />
                                              </IconButton>
