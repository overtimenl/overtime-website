  ...
  const submitForm = async (e) => {
    ...
    if (opcao === "EDITAR") {
      if (anunciar.title != "") {
        ...
        axios({
          method: "put",
          url: "http://localhost:8000/publicidadesdb",
          data: formData,
      ...
      <form className={classes.formanucio} onSubmit={submitForm}>
        ...
        <div className="input-box">
          ...
          >
            ...
            <option value="DESENVOLVIDOR">DESENVOLVIDOR</option>
            ...
            <img
              src={
                selectedImage === undefined
                  ? new URL(`../../assets/funcionarios/${img}`, import.meta.url)
