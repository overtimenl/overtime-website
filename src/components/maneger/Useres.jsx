...
import { ForwardToInbox, ToggleOn, ToggleOff,Visibility, VisibilityOff, AccountBalance, Delete, Edit } from "@mui/icons-material";
...
function Useres(props) {
	...
	const [useres, setUseres] = useState(rows)
    ...
    const getComponent = () =>{
      switch(opcao){
        case 'ADD': 
              return <Formuser opcao={opcao} setUser={setUser} user={user} setOpenModel={setOpenModel} primery={primery} secudary={secudary} />; 
        case 'EDITAR':           
              return <Formuser opcao={opcao} setUser={setUser} user={user} setOpenModel={setOpenModel} primery={primery} secudary={secudary}   />; 
        case 'APAGAR':
              return <Deleteuser setUser={setUser} user={user} setOpenModel={setOpenModel} primery={primery} secudary={secudary}/>;   
        default: 
          return null;
      }
    }
	                                        ...
	                                        <TableCell align={'start'}>
	                                        	{row.desabled ?
	                                        		<Button 
		                                                ...
		                                                color="inherit"
		                                            >
		                                                <ToggleOff sx={{ color: 'green', fontSize: '20px'}} />
		                                            </Button>
	                                        		...
	                                        		<Button 
		                                                ...
		                                                color="inherit"
		                                            >
		                                                <ToggleOn sx={{ color: `${secudary}`, fontSize: '20px'}} />
		                                            </Button>
