...
function Deletemessage({ mensage, setMensage, setOpenModel, primery, secudary }) {
    ...
    const handleDelete = (e) => { 
        ...
        axios.delete(`http://localhost:8000/messagedb/${mensage.id}`)
        .then(response => {
            setCor('#00809b')
        ...
        >
            ...
            >
                <Box sx={{mb: 2}}>
                    ...
                    >
                        {`Tem certeza que dezeja exluir do Cliente ${mensage.name} ?`}
                    </Typography>
                    <Typography
                        sx={{
                            justifyContent: 'center',
