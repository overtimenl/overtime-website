...
import { Paid, DesktopWindows, Engineering, Group,WorkHistory, Groups2, Web, Campaign, Home,  Logout, QueryStats, AccountBalance, FacebookOutlined, Twitter, Instagram, LinkedIn, InsertInvitation, MarkEmailRead, Person, LocalGroceryStore} from "@mui/icons-material";
import { AppBar, Avatar, Box,  IconButton, Button, Menu, MenuItem,  Stack, Tab, Tabs, Toolbar, Typography } from "@mui/material";
import { useEffect, useState } from 'react';
import Homemaneger from '../components/maneger/Homemaneger';
import Useres from '../components/maneger/Useres';
import Vendas from '../components/maneger/Vendas';
import Funcionarios from '../components/maneger/Funcionarios';
import Clientspainel from '../components/sellermaneger/Clientspainel';
import Dekstopapp from '../components/maneger/Dekstopapp';
import Payments from '../components/maneger/Payments';
		...
		<>
	        ...
	        >
	            <Box 
	              ...
	              />  
	              <Tab
	                icon={<DesktopWindows className={classes.icon}/>} 
	                iconPosition="start" 
	                label={
	                    <Typography className={classes.text} sx={{fontFamily: 'Arvo, serif', fontWeight: 600, fontSize: '12px'}}>
	                        APP DESKTOP
	                    </Typography>
	                } {...a11yProps(5)} className={classes.item}
	              ...
	              />  
	               <Tab
	                ...
	                } {...a11yProps(6)} className={classes.item}
	            ...
	            >
	              <TabPanel value={value} index={0}>
	                <Homemaneger primery={primery} secudary={secudary} />
	              </TabPanel>  
	              <TabPanel value={value} index={1}>
	                  <Useres primery={primery} secudary={secudary} />
	              </TabPanel>
	              <TabPanel value={value} index={2}>
	                	<Funcionarios primery={primery} secudary={secudary} />
	              </TabPanel>       
	              <TabPanel value={value} index={3}>
	                 <Vendas primery={primery} secudary={secudary} />
	              </TabPanel>
	              <TabPanel value={value} index={4}>
	                <Clientspainel primery={primery} secudary={secudary} />
	              </TabPanel>
	              <TabPanel value={value} index={5}> 
	              	<Dekstopapp primery={primery} secudary={secudary} />
	              </TabPanel>    
	              <TabPanel value={value} index={6}> 
	              	<Payments primery={primery} secudary={secudary}/>
	              </TabPanel>    
	            </Box>
	        </Stack>
	      </div>
